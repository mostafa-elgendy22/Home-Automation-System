...
set_input_delay 0.01 [get_ports reset]
set_input_delay 0.01 [get_ports SFD]
set_input_delay 0.01 [get_ports SRD]
set_input_delay 0.01 [get_ports SFA]
set_input_delay 0.01 [get_ports SW]
set_input_delay 0.01 [get_ports ST]
set_input_delay 0.01 [get_ports {temperature[5]}]
set_input_delay 0.01 [get_ports {temperature[4]}]
set_input_delay 0.01 [get_ports {temperature[3]}]
set_input_delay 0.01 [get_ports {temperature[2]}]
set_input_delay 0.01 [get_ports {temperature[1]}]
set_input_delay 0.01 [get_ports {temperature[0]}]
set_output_delay 0.1 -clock vsysclk [get_ports front_door]
set_output_delay 0.1 -clock vsysclk [get_ports rear_door]
set_output_delay 0.1 -clock vsysclk [get_ports alarm_buzzer]
set_output_delay 0.1 -clock vsysclk [get_ports window_buzzer]
set_output_delay 0.1 -clock vsysclk [get_ports heater]
set_output_delay 0.1 -clock vsysclk [get_ports cooler]
set_output_delay 0.1 -clock vsysclk [get_ports {display[2]}]
set_output_delay 0.1 -clock vsysclk [get_ports {display[1]}]
set_output_delay 0.1 -clock vsysclk [get_ports {display[0]}]
set_max_area 0.0
